<svg
    ...
    .stat {
      font: 600 14px 'Segoe UI', Ubuntu, "Helvetica Neue", Sans-Serif; fill: #75eeb2;
    }
    .stagger {
      opacity: 0;
    ...
    .rank-text {
      font: 800 24px 'Segoe UI', Ubuntu, Sans-Serif; fill: #75eeb2; 
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 126.60842883754495;
      }
    }
    ...
    @keyframes fadeInAnimation {
      ...
      <text
        ...
        class="header"
        data-testid="header"
      >Septiandro Surya Dewangga's GitHub Stats</text>
    </g>
      </g>
